 ...
 *****/
FOUNDATION_EXPORT NSString *const  USER_SELECTED_ACTIVITY;
FOUNDATION_EXPORT NSString *const  USER_SELECTED_DURATION;
FOUNDATION_EXPORT NSString *const  USER_SELECTED_TEMPERATURE;
